        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle profileToggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        Admin
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end profileMenu" aria-labelledby="profileDropdown">
                        <li><a class="dropdown-item" href="#">Shelter Settings</a></li>
                        <li><hr class="dropdown-divider profileDivider"></li>
