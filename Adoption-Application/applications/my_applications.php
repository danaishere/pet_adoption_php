...
$sql = "
    SELECT applications.id, applications.status, applications.interview_date, applications.created_at,
           ...
           pet_profiles.breed AS pet_breed, pet_profiles.photo AS pet_photo
    FROM applications
...
<table class="table table-bordered table-hover align-middle">
    <thead class="table-dark">
        <tr>
            <th>#</th><th>Pet</th><th>Species / Breed</th><th>Status</th>
            <th>Interview Date</th><th>Applied On</th><th>Action</th>
        </tr>
    </thead>
    <tbody>
