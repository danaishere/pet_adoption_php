...
$currentPets = $countRow['total'];

$capacity = $shelter['capacity'];
$remaining = $capacity - $currentPets;
...
<div class="alert alert-info">
    ...
    Total Capacity: <?= $capacity ?><br>
    Occupied: <?= $currentPets ?><br>
    Remaining Slots: <?= $remaining ?>
</div>

<form method="POST" name="shelterForm">
