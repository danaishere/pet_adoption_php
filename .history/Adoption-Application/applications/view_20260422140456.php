...
$sql = "
    SELECT applications.*,
           ...
           adopters.email,
           adopters.phone,
           adopters.housing_type,
           adopters.has_yard,
           adopters.experience,
           adopters.pet_preference,
           pet_profiles.name        AS pet_name,
           pet_profiles.species     AS pet_species,
           pet_profiles.breed       AS pet_breed,
           pet_profiles.gender      AS pet_gender,
           pet_profiles.age_years,
           pet_profiles.age_months,
           pet_profiles.color       AS pet_color,
           pet_profiles.weight_kg,
           pet_profiles.photo       AS pet_photo,
           pet_profiles.description AS pet_description
    FROM applications
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <table class="table table-borderless mb-0">
                    <tr>
                        <th>Status</th>
                        <td><span class="badge bg-<?= $badge ?> fs-6"><?= $row['status'] ?></span></td>
                    </tr>
                    <tr>
