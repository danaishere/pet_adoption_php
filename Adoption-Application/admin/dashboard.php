...
<div class="row mb-4 g-3">
    <div class="col-md-3">
        <div class="card text-white bg-secondary text-center p-3"><h5>Total</h5><h2><?= $total ?></h2></div>
    </div>
    <div class="col-md-3">
        <div class="card text-dark bg-warning text-center p-3"><h5>Pending</h5><h2><?= $pending['c'] ?></h2></div>
    </div>
    <div class="col-md-3">
        <div class="card text-white bg-success text-center p-3"><h5>Approved</h5><h2><?= $approved['c'] ?></h2></div>
    </div>
    <div class="col-md-3">
        <div class="card text-white bg-primary text-center p-3"><h5>Completed</h5><h2><?= $completed['c'] ?></h2></div>
    </div>
    <div class="col-md-3">
        <div class="card text-white bg-danger text-center p-3"><h5>Rejected</h5><h2><?= $rejected['c'] ?></h2></div>
    </div>
</div>
...
<table class="table table-bordered table-hover">
    <thead class="table-dark">
        <tr><th>#</th><th>Adopter</th><th>Pet</th><th>Status</th><th>Date Applied</th><th>Action</th></tr>
    </thead>
    <tbody>
